	...
	<div class="container">
		...
		<div class="row">
			<div class=" col-md-7">
				...
				<form role="form" action="/MVC/libros.do" method="POST">
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" readonly class="form-control" name="codigo"
								id="codigo" value="${libro.codigoLibro}"
								placeholder="Ingresa el codigo del libro"> <span
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" name="nombre" id="nombre"
								...
								placeholder="Ingresa el nombre del libro"> <span
								class="input-group-addon"><span
								class="glyphicon glyphiconasterisk"></span></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" id="existencias"
								value="${libro.existencias}" name="existencias"
								placeholder="Ingresa las existencias del libro"> <span
								class="input-group-addon"><span
								class="glyphicon glyphiconasterisk"></span></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="input-group">
							<input type="number" step="0.1" min="0" class="form-control"
								id="precio" value="${libro.precio}" name="precio"
								placeholder="Ingresa el precio del libro"> <span
								class="input-group-addon"><span
								class="glyphicon glyphiconasterisk"></span></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="input-group">
							<select name="codigoEditorial" id="codigoEditorial"
								class="form-control">
								<c:forEach items="${requestScope.listaEditoriales}"
									var="editorial">
					...
					<input type="submit" class="btn btn-info" value="Guardar"
						...
						href="/MVC/libros.do?op=listar">Cancelar</a>
				</form>
			</div>
		</div>
	</div>
	<script>
		$("#codigoAutor option[value=" + '${libro.codigoAutor}' + "]").attr(
				"selected", true);
		$("#codigoEditorial option[value=" + '${libro.codigoEditorial}' + "]")
				.attr("selected", true);
		$("#codigoGenero option[value=" + '${libro.idGenero}' + "]").attr(
				"selected", true);
	</script>
</html>